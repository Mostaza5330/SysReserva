...
public interface IClienteBO {
     ...
     *
     * @return Una lista de objetos que representa todos los clientes.
     * @throws Excepciones.BOException En caso de error uno nunca sabe.
     */
    public List<ClienteDTO> obtenerClientes() throws BOException;

    /**
     * Realiza la inserción masiva de clientes en la base de datos.
     *
     * @param clientes Una lista de objetos ClienteDTO que representan los
     * clientes a insertar.
     * @throws NegocioException En caso de error durante la inserción masiva.
     */
    void insercionMasivaClientes(List<ClienteDTO> clientes) throws NegocioException;
